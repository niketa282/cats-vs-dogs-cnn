...
from dataset import (
    resnet_train_dataloader,
    resnet_validation_dataloader
)
...
#This prevents backpropagation from changing the pretrained parameters.
...
plt.legend()
plt.savefig("resnet18_loss_plot.png")
plt.close()
